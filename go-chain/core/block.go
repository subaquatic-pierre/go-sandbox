...
// encodes header into binary format
// given buffer writes struct into binary format
...
// decodes header into new header
// given bytes writes new header object data fields
